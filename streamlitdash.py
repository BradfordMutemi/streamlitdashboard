...
# Creating a column chart of Category and Region 
...
# Downloading the data for the line chart
...
# Segment wise and Category Sales
...
# Showing some columns data in table format
import plotly.figure_factory as ff
st.subheader(":point_right: Month wise Sub-Category Sales Symmary")
